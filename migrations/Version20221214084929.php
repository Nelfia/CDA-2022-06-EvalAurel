 ...
 */
final class Version20221214084929 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE computer (id INT AUTO_INCREMENT NOT NULL, author_id INT DEFAULT NULL, brand_id INT DEFAULT NULL, model VARCHAR(50) NOT NULL, description LONGTEXT NOT NULL, price DOUBLE PRECISION NOT NULL, year INT NOT NULL, sin VARCHAR(255) NOT NULL, img VARCHAR(255) NOT NULL, INDEX IDX_A298A7A6F675F31B (author_id), INDEX IDX_A298A7A644F5D008 (brand_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
